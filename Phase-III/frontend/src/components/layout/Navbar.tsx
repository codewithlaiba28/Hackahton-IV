...
import { Menu, LogOut, Flame, Sparkles } from 'lucide-react';
          ...
          {session && (
            <>
              ...
              >
                ...
                <span className="text-xs font-bold text-white/80">0 DAY STREAK</span>
              </motion.div>

              <Badge
                className={`py-1 px-3 h-auto uppercase tracking-widest text-[10px] font-black rounded-lg border transition-all ${tierStyles[(session.user as any)?.tier as keyof typeof tierStyles] || tierStyles.free
                  }`}
              >
